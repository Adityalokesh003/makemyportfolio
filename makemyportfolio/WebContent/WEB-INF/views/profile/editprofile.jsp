		...
		<div class="accordion">
			...
			<div class="profile-view-content">
				<form>
					<div class="form-row">
						<div class="form-group col-lg-10  ">
							<label for="programming_languages">Programming Languages
								:-</label>
					...
					<div class="form-row">
						<div class="form-group col-lg-10  ">
							<label for="category_title">Category Title :-</label> <input
								type="text" class="form-control" id="category_title"
								name="category_title" value="B.Tech">
						</div>
						<div class="form-group col-lg-10  profile-submit">
							<input type="submit" class="btn btn-block btn-primary"
								name="dev_cat_update" value="Update Development Categories">
						</div>
					</div>
				</form>
			</div>
					...
					<div class="form-row">
						<div class="form-group col-lg-10  ">
							<label for="activity_title">Activity Title :-</label> <input
								type="text" class="form-control" id="activity_title"
								value="B.Tech">
						</div>
						<div class="form-group col-lg-10  ">
