...
function validatePassword(){
	...
	if(pword_length < 5 || pword_length > 20){
		...
		$("#signup input[name='password']").css("1px solid red") ;
		return false;
	}
	if(pword.search(/^[\S]+$/) < 0){
...
function validateUsername() {
	var user_name=$("#signup input[name='user_name']");
	...
	if(uname_length < 6 || uname_length > 20){
		...
		$("#signup input[name='user_name']").focus();
		$("#signup input[name='user_name']").css("1px solid red") ;
